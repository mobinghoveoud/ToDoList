        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('task.update',compact('task')) }}">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                           ...
                                           value="{{ $task->title }}" required autocomplete="title" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="detail" type="text"
                                              ...
                                              autocomplete="detail">{{ $task->detail }}</textarea>
